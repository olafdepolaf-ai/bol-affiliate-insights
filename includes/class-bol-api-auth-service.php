<?php
/**
 * Bol_API_Auth_Service Class
 *
 * Handles authentication with the Bol.com API to retrieve access tokens.
 */
...
if ( ! class_exists( 'Bol_API_Auth_Service' ) ) {
     ...
     * Bol_API_Auth_Service Class
     *
     * Handles authentication with the Bol.com API. This includes requesting
     * new access tokens, and caching them using WordPress transients to minimize
     * redundant API calls.
     */
    class Bol_API_Auth_Service {
        ...
        /**
         * Constructor for Bol_API_Auth_Service.
         *
