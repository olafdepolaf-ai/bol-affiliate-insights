...
use TuinenBalkon\AffiliateLinkChecker\Bol\Admin\AjaxHandlerService;
use TuinenBalkon\AffiliateLinkChecker\Bol\Admin\SettingsPage;
use TuinenBalkon\AffiliateLinkChecker\Bol\AffiliateLink\NullAdapter;
use TuinenBalkon\AffiliateLinkChecker\Bol\AffiliateLink\ThirstyAffiliatesAdapter;
...
use TuinenBalkon\AffiliateLinkChecker\Bol\Service\SettingsService;
...
class BolTab {
	...
	public function render(): void {
		$base_url = admin_url( 'admin.php?page=affiliate-link-checker&tab=bol' );
