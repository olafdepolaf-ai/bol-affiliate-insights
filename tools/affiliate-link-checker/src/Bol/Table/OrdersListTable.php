...
namespace TuinenBalkon\AffiliateLinkChecker\Bol\Table;
...
class OrdersListTable extends \WP_List_Table {
	...
	public function prepare_items( $data = array() ): void {
		...
		usort( $this->items, function ( $a, $b ) use ( $orderby, $order ) {
			...
			if ( in_array( $orderby, array( 'quantity', 'priceInclVat', 'commission' ), true ) ) {
	...
	public function no_items(): void {
		echo 'No orders found for the selected period.';
	}
}
